             ...
             void *user_param)
{
    ...
    if (sentinel == NULL)
    {
        struct liste_eventtypes_t *nouveau_eventtype = malloc(sizeof (liste_eventtypes_t));
        nouveau_eventtype->eventtype = eventtype;
        struct liste_events_widgets *nouveau_widget = malloc(sizeof(struct liste_events_widgets));
        ...
        nouveau_widget->next = NULL;
        nouveau_eventtype->liste = nouveau_widget;
        nouveau_eventtype->next = NULL;
               ...
               void *user_param)
{
    ...
    if (sentinel != NULL) {
        ...
        if (liste_widget != NULL) {
            ...
            if (suivant->widget.pick_id == widget->pick_id && suivant->callback == callback &&
