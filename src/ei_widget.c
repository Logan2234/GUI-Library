                        ...
                        ei_anchor_t *img_anchor)
{
    ...
    ((ei_frame_t *)widget)->text_color = (text_color != NULL) ? text_color : (ei_color_t *)&ei_font_default_color;
    ((ei_frame_t *)widget)->text_anchor = (text_anchor != NULL) ? text_anchor : (ei_anchor_t *)ei_anc_center;
    ((ei_frame_t *)widget)->img = img;
    ((ei_frame_t *)widget)->img_rect = img_rect;
    ((ei_frame_t *)widget)->img_anchor = (img_anchor != NULL) ? img_anchor : (ei_anchor_t *)ei_anc_center;
}
                         ...
                         void **user_param)
{
    ...
    ((ei_button_t *)widget)->border_width = (border_width != NULL) ? border_width : (int *)&k_default_button_border_width;
    ((ei_button_t *)widget)->corner_radius = (corner_radius != NULL) ? corner_radius : (int *)&k_default_button_corner_radius;
    ((ei_button_t *)widget)->relief = (relief != NULL) ? relief : (ei_relief_t *)ei_relief_raised;
    ((ei_button_t *)widget)->text = text;
    ((ei_button_t *)widget)->text_font = (text_font != NULL) ? text_font : ei_default_font;
    ((ei_button_t *)widget)->text_color = (text_color != NULL) ? text_color : (ei_color_t *)&ei_font_default_color;
    ((ei_button_t *)widget)->text_anchor = (text_anchor != NULL) ? text_anchor : (ei_anchor_t *)ei_anc_center;
    ((ei_button_t *)widget)->img = img;
    ((ei_button_t *)widget)->img_rect = img_rect;
    ((ei_button_t *)widget)->img_anchor = (img_anchor != NULL) ? img_anchor : (ei_anchor_t *)ei_anc_center;
                           ...
                           ei_size_t **min_size)
{
    ...
    ((ei_toplevel_t *)widget)->color = (color != NULL) ? color : (ei_color_t *)&ei_default_background_color;
    ((ei_toplevel_t *)widget)->border_width = (border_width != NULL) ? border_width : (int *)&constante;
    ((ei_toplevel_t *)widget)->title = (title != NULL) ? title : (char **)"Toplevel";
    ((ei_toplevel_t *)widget)->closable = (closable != NULL) ? closable : (ei_bool_t *)EI_TRUE;
    ((ei_toplevel_t *)widget)->resizable = (resizable != NULL) ? resizable : (ei_axis_set_t *)ei_axis_both;
    ((ei_toplevel_t *)widget)->min_size = (min_size != NULL) ? min_size : (ei_size_t **)&(ei_size_t){160, 120};
}